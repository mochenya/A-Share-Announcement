...
DEFAULT_USER_AGENT = get_str_env("SSE_USER_AGENT", BUILTIN_USER_AGENT)

_default_timeout = get_optional_float_env("SSE_TIMEOUT")
...
DEFAULT_LIMITS = httpx.Limits(
    max_connections=get_int_env("SSE_MAX_CONNECTIONS", 10),
    max_keepalive_connections=get_int_env("SSE_MAX_KEEPALIVE_CONNECTIONS", 5),
